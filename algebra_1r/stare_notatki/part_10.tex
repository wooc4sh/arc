...
\begin{remark}
	...
	\end{enumerate}
\end{remark} 
\begin{definition}[Pierścień z dzielnikiem. Ciało]
	\begin{enumerate}[label=\arabic*)]
		\item $R$ jest \textbf{pierścieniem z dzielnikiem} gdy $R$ jest pierścieniem z $\mathbf{1}$ oraz $Ra^{\ast} = R\setminus \{\mathbf{0}\} $ ($\implies \mathbf{0}\neq \mathbf{1}$ )
		\item $R$ jest \textbf{ciałem }, gdy $R$ jest \textbf{przemiennym} pierścieniem z dzielnikiem.
	\end{enumerate}
\end{definition} 
\textbf{Przykłady:}
\begin{enumerate}[label=\arabic*)]
